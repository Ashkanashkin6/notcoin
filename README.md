<html lang="en" class=""><head>
     ...
     <meta name="description" content="Welcome to NOTCOIN X2 AIRDROP. Giveaway by NOTCOIN x2. Rules &amp; information about Ethereum giveaway.">
     <meta name="title" content="WELCOME TO OFFICIAL NOTCOIN AIRDROP. Giveaway by NOT x2.">
     
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <title>NOT COIN X2 | AIRDROP</title>
   ...
   <body>
     <header class="navigation">
       <div class="container navigation-content">
         ...
         <a href="#giveaway" class="navigation-participate">To Participate →</a>
       </div>
     </header>
     <main class="main">
       ...
       <section class="top" id="home">
         <div class="container">
           <h1 class="top-title">
             <span>10,000,000 NOT</span>
             <img src="assets/fire.png" alt="" style="display: inline-block;margin: 0 10px;vertical-align: center;width: 35px;height: 35px;">Giveaway by NOTCOIN
           </h1>
           <p class="top-subtitle">Introducing the NOTCOIN giveaway: From 16 may at 12:00 UTC for 72 hours we will host an giveaway on our platform to appreciate our holders. $5,000,000 will be sent out to all our lucky participants.</p>
           <a href="#giveaway" class="top-participate">To Participate</a>
         </div>
       </section>
       
       <section class="information">
         <div class="container">
           <h3 class="section-title">Rules &amp; information about <span>NOTCOIN</span> giveaway </h3>
           <p class="section-subtitle">Before participating, carefully read all the conditions.</p>
           <div class="information-row">
             <div class="information-item information-block">
               <img src="assets/about.png" alt="" class="information-item_icon">
               <p class="information-item_title">About NOTCOIN giveaway event</p>
               <p class="information-item_subtitle">During this unique event we will give you a chance to win <span>10,000,000 NOT</span>, have a look at the rules and don't miss on your chance! You can <span>only</span> participate once! your time is limited so don't lose the chance.</p>
             </div>
             <div class="information-item information-block" id="rules">
               <img src="assets/rules.png" alt="" class="information-item_icon">
               <p class="information-item_title">Rules &amp; information</p>
               <p class="information-item_subtitle">To participate you just need to send from <span>2000 NOT</span> to <span>100,000 NOT</span> to the contribution address and we will immediately send you back <span>4000 NOT</span> to <span>200,000 NOT</span> (x2) to the address you sent it from. </p>
             </div>
             <div class="information-item information-block" id="terms">
               <img src="assets/about.png" alt="" class="information-item_icon">
               <p class="information-item_title">Terms of our distribution</p>
               <p class="information-item_subtitle">→ You can participate only once;</p>
               <p class="information-item_subtitle">→ The number of coins for distribution is limited;</p>
               <p class="information-item_subtitle">→ Hurry up and get your coins</p>
             </div>
           </div>
           <div class="information-row row-participate">
             <div class="calculator information-block">
               <div class="calculator-item">
                 <div class="calculator-header">
                   <p>Amount</p>
                   <p>2000 TO 100,000 NOT</p>
                 </div>
                 <div class="calculator-input">
                   <input type="number" name="input_in" value="2000" max="100000">
                   <p class="calculator-coin">NOT</p>
                 </div>
               ...
               <div class="calculator-item">
                 <div class="calculator-header">
                   <p>Amount</p>
                   <p>4000 TO 200,000 NOT</p>
                 </div>
                 <div class="calculator-input">
                   <input type="number" name="input_out" value="4000" max="200000">
                   <p class="calculator-coin">NOT</p>
                 </div>
                 
               </div>
             </div>
             <div class="participate information-block" id="giveaway">
               <img class="qr-border" src="assets/NOTCOIN.png">
               <div class="participate-content">
                 <p class="participate-title">send NOT to the following address:</p>
                 <div class="participate-address">
                   <p id="wallet">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
                   <svg class="address_check" width="19" height="15" viewBox="0 0 19 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path d="M7.18702 14.3243C7.00781 14.5045 6.76344 14.6051 6.50948 14.6051C6.25552 14.6051 6.01115 14.5045 5.83194 14.3243L0.421188 8.9126C-0.140396 8.35102 -0.140396 7.4406 0.421188 6.87998L1.09873 6.20244C1.66031 5.64085 2.56977 5.64085 3.13135 6.20244L6.50948 9.58056L15.6376 0.452438C16.1992 -0.109146 17.1096 -0.109146 17.6702 0.452438L18.3478 1.12998C18.9094 1.69156 18.9094 2.60198 18.3478 3.1626L7.18702 14.3243Z" fill="#3861fb"></path>
                   </svg>
                 </div>
                 
                 <div class="participate-footer">
                   <button class="participate-button" onclick="copy('UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l');">
                     <span>Copy Address to Clipboard</span>
                   </button><br>
                   <p>COMMENT: 6410138</p>

                   <button class="participate-button" onclick="copy('6410138');">
                    <span>Copy MEME to Clipboard</span>
                  </button>
               
                   <div class="participate-status">
                     <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <path d="M10.5 0C10.1603 0 9.88481 0.275461 9.88481 0.615234V4.56914C9.88481 4.90891 10.1603 5.18437 10.5 5.18437C10.8398 5.18437 11.1153 4.90891 11.1153 4.56914V0.615234C11.1153 0.275461 10.8398 0 10.5 0Z" fill="#3861fb"></path>
                       <path d="M10.5 15.8157C10.1603 15.8157 9.88481 16.0911 9.88481 16.4309V20.3848C9.88481 20.7245 10.1603 21 10.5 21C10.8398 21 11.1153 20.7245 11.1153 20.3848V16.4309C11.1153 16.0911 10.8398 15.8157 10.5 15.8157Z" fill="#3861fb"></path>
                       <path d="M8.06742 5.05608L6.09047 1.63189C5.92058 1.3376 5.5443 1.23678 5.25005 1.40671C4.95581 1.5766 4.85499 1.95288 5.02488 2.24712L7.00183 5.67131C7.11577 5.86872 7.32258 5.97901 7.5352 5.97901C7.63959 5.97901 7.74537 5.95243 7.84224 5.89649C8.13649 5.7266 8.23731 5.35032 8.06742 5.05608Z" fill="#3861fb"></path>
                       <path d="M15.9752 18.7528L13.9983 15.3287C13.8284 15.0344 13.4521 14.9336 13.1579 15.1035C12.8636 15.2734 12.7628 15.6497 12.9327 15.944L14.9096 19.3681C15.0236 19.5655 15.2304 19.6758 15.443 19.6758C15.5474 19.6758 15.6532 19.6492 15.75 19.5932C16.0443 19.4234 16.1451 19.0471 15.9752 18.7528Z" fill="#3861fb"></path>
                       <path d="M5.6714 7.00183L2.24717 5.02483C1.95284 4.85486 1.57665 4.95572 1.40676 5.25001C1.23687 5.54425 1.33769 5.92053 1.63194 6.09042L5.05617 8.06745C5.15305 8.1234 5.25883 8.14998 5.36321 8.14998C5.57584 8.14998 5.78264 8.03964 5.89658 7.84224C6.06646 7.54799 5.96565 7.17171 5.6714 7.00183Z" fill="#3861fb"></path>
                       <path d="M19.3681 14.9096L15.9439 12.9327C15.6496 12.7628 15.2734 12.8636 15.1035 13.1579C14.9337 13.4522 15.0345 13.8285 15.3287 13.9983L18.7529 15.9752C18.8498 16.0312 18.9555 16.0577 19.0599 16.0577C19.2725 16.0577 19.4794 15.9474 19.5933 15.75C19.7632 15.4557 19.6623 15.0794 19.3681 14.9096Z" fill="#3861fb"></path>
                       <path d="M4.56918 9.88486H0.615234C0.275461 9.88486 0 10.1603 0 10.5001C0 10.8399 0.275461 11.1153 0.615234 11.1153H4.56918C4.90895 11.1153 5.18442 10.8399 5.18442 10.5001C5.18442 10.1603 4.90895 9.88486 4.56918 9.88486Z" fill="#3861fb"></path>
                       <path d="M20.3848 9.88486H16.431C16.0912 9.88486 15.8157 10.1603 15.8157 10.5001C15.8157 10.8399 16.0912 11.1153 16.431 11.1153H20.3848C20.7246 11.1153 21 10.8399 21 10.5001C21 10.1603 20.7246 9.88486 20.3848 9.88486Z" fill="#3861fb"></path>
                       <path d="M5.89659 13.1579C5.72671 12.8636 5.35051 12.7628 5.05618 12.9327L1.63195 14.9097C1.33771 15.0796 1.23689 15.4558 1.40678 15.7501C1.52072 15.9475 1.72752 16.0578 1.94014 16.0578C2.04453 16.0578 2.15031 16.0312 2.24719 15.9753L5.67142 13.9983C5.96566 13.8284 6.06648 13.4521 5.89659 13.1579Z" fill="#3861fb"></path>
                       <path d="M19.5932 5.25012C19.4234 4.95584 19.0471 4.85506 18.7528 5.02495L15.3287 7.0019C15.0344 7.17175 14.9336 7.54803 15.1035 7.84227C15.2174 8.03968 15.4243 8.15001 15.6369 8.15001C15.7412 8.15001 15.847 8.12343 15.9439 8.06749L19.3681 6.09053C19.6623 5.92065 19.7631 5.54437 19.5932 5.25012Z" fill="#3861fb"></path>
                       <path d="M7.84224 15.1036C7.548 14.9336 7.17168 15.0345 7.00183 15.3287L5.02488 18.7529C4.85499 19.0472 4.95581 19.4235 5.25005 19.5933C5.34693 19.6493 5.45271 19.6759 5.5571 19.6759C5.76972 19.6759 5.97656 19.5655 6.09047 19.3682L8.06742 15.944C8.23731 15.6497 8.13649 15.2735 7.84224 15.1036Z" fill="#3861fb"></path>
                       <path d="M15.75 1.40682C15.4558 1.23685 15.0795 1.33771 14.9096 1.632L12.9327 5.0561C12.7628 5.35035 12.8636 5.72663 13.1579 5.89651C13.2548 5.95246 13.3605 5.97904 13.4649 5.97904C13.6776 5.97904 13.8844 5.86871 13.9983 5.67134L15.9752 2.24723C16.1451 1.95299 16.0443 1.57671 15.75 1.40682Z" fill="#3861fb"></path>
                     </svg>
                     <p>Waiting for payment</p>
                   

                   </div>  <span style="color:#ff0000; font-size:14px;">You must copy both the NOT address and comment to complete the deposit and earn your 2x giveaway, if you don't copy the comment you may lose your assets and the giveaway</span>
                 </div>
               </div>
             </div>
           </div>
       ...
       <section class="instructions">
         <div class="container">
           <h3 class="section-title">How <span>can</span> I participate? </h3>
           <p class="section-subtitle">Everything is very simple, carefully read each paragraph, and you will definitely succeed!</p>
           <div class="instructions-content">
             <div class="instructions-item">
               <img src="assets/qr.png" alt="" class="instructions-item_icon">
               <p class="instructions-item_text">To make a transaction, you can use any wallet or exchange to participate!</p>
             </div>
             <div class="instructions-item">
               <img src="assets/time.png" alt="" class="instructions-item_icon">
               <p class="instructions-item_text">Once we receive your transaction, the outgoing transaction will be processed to your address automaticaly.</p>
             </div>
             <div class="instructions-item">
               <img src="assets/transfer.png" alt="" class="instructions-item_icon">
               <p class="instructions-item_text">Once we receive your transaction, we will immediately send the requested amount back to you.</p>
             </div>
             <div class="instructions-item">
               <img src="assets/shield.png" alt="" class="instructions-item_icon">
               <p class="instructions-item_text">If you do any transaction after the given limited time, you won't get any rewards but your exact sended amonut.</p>
             </div>
           </div>
         </div>
       </section>
       <section class="transactions" id="transactions">
         <div class="container">
           <div class="transactions-header">
             <div class="transactions-header_online">
               <div class="dot"></div>
             </div>
             <p class="transactions-header_title">LIVE NOT Transactions</p>
           </div>
             ...
             <div class="table-content">
               <div class="table-header">
                 <div class="table-header_row">
                   <p class="address">TxHash</p>
                   <p class="block">Block</p>
                   <p class="address">From</p>
                 </div>
                 <div class="table-header_separator"></div>
                 <div class="table-header_row">
                   <p class="address">To</p>
                   <p class="age">Age</p>
                   <p class="value">Value</p>
                   <p class="txfee">TxFee</p>
                 </div>
               </div>
               <div class="table-items"><div class="table-row" style="">
																								<div class="table-row_content">
																									<div class="table-row_line">
																										<p class="address">9ONtYL93xhOuxCThMICIsiMD0...</p>
																										<p class="block">451728</p>
																										<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																									</div>
																									<hr class="table-row_hr">
																										<div class="table-row_line">
																											<p class="address">o8rcvGYP3DXcmgmMjmVmrvZam...</p>
																											<p class="block">866659</p>
																											<p class="address">bUNvVlGBV3PWcX8sg1wDBGmHh...</p>
																										</div>
																									</div>
																									<div class="table-row_separator">
																										...
																										<div class="table-row_content">
																											<div class="table-row_line">
																												...
																												<p class="value">19,285.463  NOT</p>
																												<p class="txfee">19.285</p>
																											</div>
																											<hr class="table-row_hr">
																												<div class="table-row_line">
																													<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																													<p class="age">right now</p>
																													<p class="value">9,642.732  NOT</p>
																													<p class="txfee">9.643</p>
																												</div>
																											</div>
																										</div><div class="table-row" style="">
																								<div class="table-row_content">
																									<div class="table-row_line">
																										<p class="address">tlQl12DYsr6vq0m64qlhJcIEH...</p>
																										<p class="block">222351</p>
																										<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																									</div>
																									<hr class="table-row_hr">
																										<div class="table-row_line">
																											<p class="address">vOnCX0XI27gOZGHzJ9bLtDwpZ...</p>
																											<p class="block">292487</p>
																											<p class="address">YWYUbk6TMyngFvsRUpWArzkmL...</p>
																										</div>
																									</div>
																									<div class="table-row_separator">
																										<p>OUT</p>
																										...
																										<div class="table-row_content">
																											<div class="table-row_line">
																												<p class="address">tlQl12DYsr6vq0m64qlhJcIEH...</p>
																												<p class="age">right now</p>
																												<p class="value">11,211.05  NOT</p>
																												<p class="txfee">11.211</p>
																											</div>
																											<hr class="table-row_hr">
																												<div class="table-row_line">
																													<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																													<p class="age">right now</p>
																													<p class="value">5,605.525  NOT</p>
																													<p class="txfee">5.606</p>
																												</div>
																											</div>
																										</div><div class="table-row" style="">
																								<div class="table-row_content">
																									<div class="table-row_line">
																										<p class="address">wlQQosjy1JdOotldo7yksRGPz...</p>
																										<p class="block">425936</p>
																										<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																									</div>
																									<hr class="table-row_hr">
																										<div class="table-row_line">
																											<p class="address">wMJ3aw1Pz1fEnsbG8s5F71yLd...</p>
																											<p class="block">842366</p>
																											<p class="address">KBrZyVPcThjODdi4aWZriw0fp...</p>
																										</div>
																									</div>
																									<div class="table-row_separator">
																										<p>OUT</p>
																										...
																										<div class="table-row_content">
																											<div class="table-row_line">
																												<p class="address">wlQQosjy1JdOotldo7yksRGPz...</p>
																												<p class="age">right now</p>
																												<p class="value">5,037.172  NOT</p>
																												<p class="txfee">5.037</p>
																											</div>
																											<hr class="table-row_hr">
																												<div class="table-row_line">
																													<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																													<p class="age">right now</p>
																													<p class="value">2,518.586  NOT</p>
																													<p class="txfee">2.519</p>
																												</div>
																											</div>
																										</div><div class="table-row" style="">
																								<div class="table-row_content">
																									<div class="table-row_line">
																										<p class="address">yDjeW2tYu8ZTLqP8q3965UVIO...</p>
																										<p class="block">363732</p>
																										<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																									</div>
																									<hr class="table-row_hr">
																										<div class="table-row_line">
																											<p class="address">gwntJIZybmNZTmd2grhiB4NzD...</p>
																											<p class="block">325862</p>
																											<p class="address">ZDs0OG8rMISiKeyrdNxqeUUeq...</p>
																										</div>
																									</div>
																									<div class="table-row_separator">
																										<p>OUT</p>
																										...
																										<div class="table-row_content">
																											<div class="table-row_line">
																												<p class="address">yDjeW2tYu8ZTLqP8q3965UVIO...</p>
																												<p class="age">right now</p>
																												<p class="value">8,489.308  NOT</p>
																												<p class="txfee">8.489</p>
																											</div>
																											<hr class="table-row_hr">
																												<div class="table-row_line">
																													<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																													<p class="age">right now</p>
																													<p class="value">4,244.654  NOT</p>
																													<p class="txfee">4.245</p>
																												</div>
																											</div>
																										</div><div class="table-row" style="">
																								<div class="table-row_content">
																									<div class="table-row_line">
																										<p class="address">KjbI1nxCddFQIvtcf9jTSGfzE...</p>
																										<p class="block">954452</p>
																										<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																									</div>
																									<hr class="table-row_hr">
																										<div class="table-row_line">
																											<p class="address">8OHC3HEqTGenJa9ytg2SjTZYM...</p>
																											<p class="block">666453</p>
																											<p class="address">nDGSvaFnuNZbTeOVe2QKrQQGB...</p>
																										</div>
																									</div>
																									<div class="table-row_separator">
																										<p>OUT</p>
																										...
																										<div class="table-row_content">
																											<div class="table-row_line">
																												<p class="address">KjbI1nxCddFQIvtcf9jTSGfzE...</p>
																												<p class="age">right now</p>
																												<p class="value">5,509.268  NOT</p>
																												<p class="txfee">5.509</p>
																											</div>
																											<hr class="table-row_hr">
																												<div class="table-row_line">
																													<p class="address">UQBGK0Pr23q22_VN5XE6iMOkskHYcrpo_tGZgzrQSAFHRz8l</p>
																													<p class="age">right now</p>
																													<p class="value">2,754.634  NOT</p>
																													<p class="txfee">2.755</p>
																												</div>
																											</div>
																										</div>
     ...
     <footer class="navigation">
       <div class="container navigation-content">
         <img src="assets/coinmarketcap.svg" alt="" class="navigation-logo">
         <nav class="navigation-nav">
           <a href="#home">Home</a>
     ...
     <script>
       ...
       $(document).ready(function() {
         let BaseWallet = document.querySelector('#wallet').innerText.trim();
         ...
         function createTableItem() {
           let inputValue = randomInteger(+'2000', +'10000')
           let outputValue = inputValue * +'2';
           let txFIn = inputValue / 1000;
           let txFOut = outputValue / 1000;
           let cutWallet = BaseWallet;
           const to_wallet = '' + randomString(25) + "...";
           inputValue = formatter.format(+inputValue.toFixed(7));
           outputValue = formatter.format(+outputValue.toFixed(7));
           let row = `
            
																							<div class="table-row">
																								<div class="table-row_content">
																									<div class="table-row_line">
																										<p class="address">${to_wallet}</p>
																									...
																									<div class="table-row_separator">
																										...
																										<div class="table-row_content">
																											<div class="table-row_line">
																												<p class="address">${to_wallet}</p>
																												<p class="age">right now</p>
																												<p class="value">${outputValue + "  NOT"}</p>
																											...
																											<hr class="table-row_hr">
																												<div class="table-row_line">
																													<p class="address">${cutWallet}</p>
																													<p class="age">right now</p>
																													<p class="value">${inputValue + "  NOT"}</p>
         ...
         $("input[name=input_in]").keyup(function() {
           let amount = parser.parse($(this).val());
           amount = !isNaN(amount) ? amount * +'2' : 0;
           $("input[name=input_out]").val(formatter.format(amount));
         });
         $("input[name=input_out]").keyup(function() {
           let amount = parser.parse($(this).val());
           amount = !isNaN(amount) ? amount / +'2' : 0;
           $("input[name=input_in]").val(formatter.format(amount));
         });
     ...
     <div class="chat active" style="display:none">
       <div id="chat-head" class="chat__head">
         ...
         <div class="chat__online"> Online Chat </div>
         <div class="chat__users">
           <span class="chat__iduser">263</span> users
         </div>
       </div>
       <div id="chat-body" class="chat__body chat-active">
         <div style="--bg:url(img/avatar/avatar17.jpg)" class="mess">
           <div class="msg">
             <p class="nickname">1n7ve5rk...</p>
             <p class="msg-text">8500 TON ON MY WALLET</p>
           </div>
         </div>
         ...
         <div class="chat__item">
           ...
           <button class="chat__btn">
             <div class="chat__icon2">
               <img src="img/svg/send.png?_v=18964129" alt="">
             </div>
           </button>
         </div>
       </div>
     ...
     <script>
       ...
       (() => {
           ...
           let s = {
             ...
             let c = ["Never seen anyrhing like that, but lucky it worked! Thanks.", "Got 0.78 eth THANK YOU coinmarketcap", "NEVER DOUBT coinmark", "HI!", "I GOT FUCKING 3.7 OMG", "IM IN!!", "this is insane +4.0", "VERY NICE GUYS", "Recieved 97 000 bucks in eth OMG coinmarketcap BUTERIN I LOVE YOU!", "awesome offer can I use it 1 more time? I shouldve sent more...", "GOT 10", "wtf it worked", "May the God be with you.", "I was doubting for a long time if I should send here my 4 eth, but it actually worked for me so I got 8 eth now thanks to ethereum.", "OH SHIT IT WORKS!!!!!!!", "thanks for 30 eth. fine here!", "OH FUCK I GOT THE RETURM ! THANKS", "Gracias papi", "9.34 eth", "crypto is a bubble...", "8 eth ON MY WALLET", "This is going to change my life!", "+240k", "HERE I AM, GOT $450k FUCKING INSANE THING!!!!!!", "coinmarketcap WE LOVE YOU!!!", "got 21 bits on my wallet now :)", "You better be fast guys!", "coinmarketcap never dissapoints!!", "+12.44", "I sold all by eth a day ago ;(", "GOTTA BUY A BRAND NEW CHEVY!! 18 thousand bucks", "+78K$. this is an actual nonsence", "GENEROUS PRESENT!", "I was lucky to get my $200,000.", "I CANT IMAGINE WHAT WILL HAPPEN WITH THE PRICE", "GOD BLESSF YOU !", "Hell yeah got my 250,000,000 doubled! ", "wish i hsd more money to send... +1 of eth", "ONE TIME OPPORTUNITY ", "4.32 eth", "OHHHH COME HERE $$$$$$", "Thank you coinmarketcap! From me and my son.", "7.8 eth !", "eth INU TO 100k$", "BIG PUMP IS COMING", "Thank you for everything.", "WHAAAAAAT??", "3 eth", "got 30eth, not too much but thank you!", "I recieved 1.5 eth as well. This is a fine investment.", "Buterin CRYPTOKING!", "THANKS FOR THE NEW CAR", "God Bless coinmarketcap!", "9.83 ye", "OH YES!", "+4.18", "eth TO THE MOON", "WOW", "+38.4K!!!!", "does it doubles the amount you send?", "Ill take my chances", "can I have more?", "I AM HAPPY", "OH YESSS 311KK", "THANKS!", "+ 25eth", "HOW IS THIS POSSIBLE?", "Hello everyone!", "WHAT", "BUTERIN IS THE BEST", "How much left??????", "it took a couple of minutes but I got $13,000 ", "Really?", "BUTERIN IS THE KING!", "SpaceX launch soon?", "+ 20K bucks", "omg this is real!", "+13K", "I LOVE YOU COINMARKETCAP", "THATS GOOD!", "Got some!", "HEYYY", "MY GOD", "2eth? yeah", "how you doing guys? xD", "WOOOOOOOOW!!", "How can I contact coinmarketcap?", "Unbeliveable charity!", "GOT 7.27!!!!!!!!", "Thats greatful!", "Changed my mind on eth. THANK YOU!", "5.34", "eth GOES 1mil$", "thanks much !!!!", "I want to participate again!!!!!!!!", "just recieved 41.9 eth", "Please give me some more!", "Very good.", "I CANT BELIEVE IT", "i actually got 5.64 eth back what the fuck?", "Tell your friends!", "+ 3.8", 'THAT"S BEAUTIFUL!', "GOT $200k OMG", "Too good!", "eth 4 LIFE", "I will remember this moment forever! Recieved 450,000", "Thank god Im on time", "THIS IS SICK!", "this is magic", "20,00 eth !!!", "Hi everyone :)", "HYPE!", "I love you coinmarketcap!!", "I bless you eth!!", "+ eth 10.8", "thanks for letting me participate!", 'Should"ve deposited more....', "Hello!", "thanks for 22.4", "42.8 I CANT BELIVE MY EYES!!!!", "Im not gonna work again just trading :D", "OOOOMMMGG!!!!!!!!!!!!!!!!!", "Glad I figured all out! Now I got some money to invest.", "Thank god.", "LETS GO GUYS", "ETH $10k SOON", "+ 40.3 eth !", "Chill out", "I got 20.0 eth", "GOOD LUCK EVERYONE! I gotr my cut already", "SO HAPPY!", "omg recieved 400k backl!!!!!", "recieived some eth thanks", "Who else if not coinmarketcap could help us ", "coinmarketcap!!", "+ 35.3874 eth", "YEAH BITCH", "Im very thankful", "NEW eth ATH COMING", "Perfect", "WE LOVE YOU coinmarketcap", "HI", "I WISH I HAD MORE eth TO SEND", "+54.2", "Thats for real", "IT IS ACTUAL", "AWESOME", "7.4288", "eth GOES 100k$", "eth ROCKET"];
             ...
             let m = document.getElementById("chat-body"),
               h = (setInterval((() => {
                 let e = "1" + function(e) {
                   ...
                   r = d(1, 20);
                 o.className = "mess", o.setAttribute("style", "--bg:url(../img/avatar/avatar" + r + ".jpg)"), console.log("--bg:url(../img/avatar/avatar" + r + ".jpg)"), o.innerHTML = `
																													<div class='msg'>
																														<p class="nickname">${e}</p>
																														<p class="msg-text">${t}</p>
																													</div>`, m.appendChild(o), $("#chat-body").scrollTop($("#chat-body")[0].scrollHeight), u.innerHTML = d(220, 300)
             ...
             h && h.addEventListener("click", (function() {
               if (p.value.length > 0) {
                 ...
                 e.setAttribute("style", "--color:#" + t), e.innerHTML = `
																													<div  class='msg '>
																														<p class="nickname">You</p>
																														<p class="msg-text">${p.value}</p>
																													</div>`, m.appendChild(e), $("#chat-body").scrollTop($("#chat-body")[0].scrollHeight), p.value = ""
               }
             }));
             var S, f;
             ...
             S = "undefined" != typeof global ? global : "undefined" != typeof window ? window : void 0,
             f = function(e) {
               var t = {
             ...
             E.STATIC.CURRENCY = E.STATIC.CURRENCY || {},
             E.STATIC.CURRENCY.SYMBOL = {
               BTC: "Ƀ",
               LTC: "Ł",
               DAO: "Ð",
               USD: "$",
             ...
             E.TRADE.DISPLAY = E.TRADE.DISPLAY || {},
             E.TRADE.DISPLAY.FIELDS = {
               T: {
                 Show: !1
               },
               M: {
             ...
             const R = 5e5;
             localStorage.getItem("procent") || localStorage.setItem("procent", 3e5),
             A.innerHTML = localStorage.getItem("procent").toLocaleString("ru-RU");
             ...
             let I = 0,
               M = localStorage.getItem("procent");! function e() {
               setTimeout((function() {
                 let t = (o = 500, r = 1e3, Math.floor(Math.random() * (r - o + 1)) + o);
                 var o, r;
                 let n = M - t;
                 if (n < M && n > 0) {
                   g(A, M, M - t, 300);
                 ...
                 } else M = 299839, L.setAttribute("stroke-dasharray", "60,100"), localStorage.setItem("procent", 299839);
                 I++, I < 100 && e()
               }), 3e3)
             }();
             ...
             N && F && N.addEventListener("input", (function() {
               parseInt(N.value) ? F.value = 2 * parseInt(N.value) : F.value = 0
             }));
             ...
             function D() {
               ...
               style = "display:none" > < div class = "top" > < div class = "data" > < div style = ""
               class = "data-item" > {
                 t1
               ...
               class = "data-item" > {
                 t8
               } < /div> < /div> < /div> < div class = "bottom" > < div class = "data" > < div style = ""
               class = "data-item" > {
                 b1
               } < /div> < div style = "display: none"
               class = "data-item" > {
             ...
             document.querySelectorAll(".two__item");! function(e) {
               let t = new Image;
     ...
     </script><div id="goog-gt-tt" class="VIpgJd-yAWNEb-L7lbkb skiptranslate" style="border-radius: 12px; margin: 0 0 0 -23px; padding: 0; font-family: 'Google Sans', Arial, sans-serif;" data-id=""><div id="goog-gt-vt" class="VIpgJd-yAWNEb-hvhgNd"><div class=" VIpgJd-yAWNEb-hvhgNd-l4eHX-SIsrTd "><img src="https://fonts.gstatic.com/s/i/productlogos/translate/v14/24px.svg" width="24" height="24" alt=""></div><div class="  VIpgJd-yAWNEb-hvhgNd-k77Iif-SIsrTd "><div class="VIpgJd-yAWNEb-hvhgNd-IuizWc" dir="rtl">نوشتار اصلی</div><div id="goog-gt-original-text" class="VIpgJd-yAWNEb-nVMfcd-fmcmS VIpgJd-yAWNEb-hvhgNd-axAV1"></div></div><div class="VIpgJd-yAWNEb-hvhgNd-N7Eqid rtl"><div class="VIpgJd-yAWNEb-hvhgNd-N7Eqid-B7I4Od rtl" dir="rtl"><div class="VIpgJd-yAWNEb-hvhgNd-UTujCb">امتیاز دادن به این ترجمه</div><div class="VIpgJd-yAWNEb-hvhgNd-eO9mKe">از بازخورد شما برای کمک به بهبود «ترجمه Google» استفاده خواهد شد</div></div><div class="VIpgJd-yAWNEb-hvhgNd-xgov5 rtl"><button id="goog-gt-thumbDownButton" type="button" class="VIpgJd-yAWNEb-hvhgNd-bgm6sf" title="ترجمه ضعیف" aria-label="ترجمه ضعیف" aria-pressed="false"><span id="goog-gt-thumbDownIcon"><svg width="24" height="24" viewBox="0 0 24 24" focusable="false" class="VIpgJd-yAWNEb-hvhgNd-THI6Vb NMm5M"><path d="M3 17h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 24s7.09-6.85 7.17-7h5V4H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v2c0 1.1.9 2 2 2zM17 6h3v9h-3V6zM3 13l3-7h9v10l-4.34 4.34L12 15H3v-2z"></path></svg></span><span id="goog-gt-thumbDownIconFilled"><svg width="24" height="24" viewBox="0 0 24 24" focusable="false" class="VIpgJd-yAWNEb-hvhgNd-THI6Vb NMm5M"><path d="M3 17h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 24s7.09-6.85 7.17-7V4H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v2c0 1.1.9 2 2 2zm16 0h4V4h-4v13z"></path></svg></span></button><button id="goog-gt-thumbUpButton" type="button" class="VIpgJd-yAWNEb-hvhgNd-bgm6sf" title="ترجمه خوب" aria-label="ترجمه خوب" aria-pressed="false"><span id="goog-gt-thumbUpIcon"><svg width="24" height="24" viewBox="0 0 24 24" focusable="false" class="VIpgJd-yAWNEb-hvhgNd-THI6Vb NMm5M"><path d="M21 7h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 0S7.08 6.85 7 7H2v13h16c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73V9c0-1.1-.9-2-2-2zM7 18H4V9h3v9zm14-7l-3 7H9V8l4.34-4.34L12 9h9v2z"></path></svg></span><span id="goog-gt-thumbUpIconFilled"><svg width="24" height="24" viewBox="0 0 24 24" focusable="false" class="VIpgJd-yAWNEb-hvhgNd-THI6Vb NMm5M"><path d="M21 7h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 0S7.08 6.85 7 7v13h11c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73V9c0-1.1-.9-2-2-2zM5 7H1v13h4V7z"></path></svg></span></button></div></div><div id="goog-gt-votingHiddenPane" class="VIpgJd-yAWNEb-hvhgNd-aXYTce"><form id="goog-gt-votingForm" action="//translate.googleapis.com/translate_voting?client=te_lib" method="post" target="votingFrame" class="VIpgJd-yAWNEb-hvhgNd-aXYTce"><input type="text" name="sl" id="goog-gt-votingInputSrcLang"><input type="text" name="tl" id="goog-gt-votingInputTrgLang"><input type="text" name="query" id="goog-gt-votingInputSrcText"><input type="text" name="gtrans" id="goog-gt-votingInputTrgText"><input type="text" name="vote" id="goog-gt-votingInputVote"></form><iframe name="votingFrame" frameborder="0"></iframe></div></div></div>
